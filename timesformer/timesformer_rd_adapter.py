...
class TimesformerWithRedlightAdapter(ONDAgent):
    def __init__(self,
                 fe_params,
                 kl_params,
                 evm_params,
        ...
        """
        Constructor for X3D with red light adapter
    ...
    def initialize(self, toolset: Dict):
        ...
        Returns:
            None
        """
        self.detector = TimesformerWithRedlightDetector(toolset['session_id'],
                                                        toolset['test_id'],
                                                        toolset['test_type'],
                                                        self.fe_params,
                                                        self.kl_params,
