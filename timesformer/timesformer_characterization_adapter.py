...
from timesformer.timesformer_characterization import TimesformerWithCharacterization


class TimesformerWithCharacterizationAdapter(ONDAgent):
    def __init__(self,
                 fe_params,
                 kl_params,
                 evm_params,
        ...
        """
        Constructor for timesformer with characterization
        Returns:
            None
        """
    ...
    def initialize(self, toolset: Dict):
        ...
        Returns:
            None
        """
        self.detector = TimesformerWithCharacterization(toolset['session_id'],
                                                        toolset['test_id'],
                                                        toolset['test_type'],
                                                        self.fe_params,
                                                        self.kl_params,
